        ...
        <div className="max-w-[1920px] mx-auto px-6 py-5">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-800 transition-colors shadow-sm disabled:opacity-50"
            >
          ...
          <div className="mt-5 flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-zinc-200 bg-white pl-10 pr-4 py-2.5 text-sm shadow-sm transition-colors placeholder:text-zinc-400 focus:outline-none focus:border-zinc-400 focus:ring-2 focus:ring-zinc-900/5"
              />
            </div>
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-lg border border-zinc-200 bg-white pl-10 pr-10 py-2.5 text-sm shadow-sm transition-colors focus:outline-none focus:border-zinc-400 focus:ring-2 focus:ring-zinc-900/5"
              >
            ...
            <div className="flex gap-2">
              <input
                ...
                className="rounded-lg border border-zinc-200 bg-white px-3 py-2.5 text-sm shadow-sm focus:outline-none focus:border-zinc-400 focus:ring-2 focus:ring-zinc-900/5"
              />
              <input
                type="date"
                value={fechaFin}
